...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WhatStackApi.ApiErrorErrorInnerError();
  });
  ...
  describe('ApiErrorErrorInnerError', function() {
    it('should create an instance of ApiErrorErrorInnerError', function() {
      ...
      //var instance = new WhatStackApi.ApiErrorErrorInnerError();
      //expect(instance).to.be.a(WhatStackApi.ApiErrorErrorInnerError);
    });
